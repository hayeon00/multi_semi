...
public class TokenProvider {
    ...
    private static final long ACCESS_TOKEN_EXPIRE_TIME = 1000 * 60 * 1;     //3분
    private static final long REFRESH_TOKEN_EXPIRE_TIME =1000L * 60 * 60 *24 * 1; //1000L * 60 * 60 * 24 * 1;  // 1일
